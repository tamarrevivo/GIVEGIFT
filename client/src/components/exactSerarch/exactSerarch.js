...
// const ExactSerarch = (props) => {
//     return (10 );
// }
// const mapStateToProps = (state) => {
//     useEffect(() => { props.getCategory()},[]);
//     return {
//         parentCategory: state.categoryPart.categoryArr,
//         gift: state.giftPart.giftArr
//     }
// }
// export default connect(mapStateToProps, { getCategory })(ExactSerar)
